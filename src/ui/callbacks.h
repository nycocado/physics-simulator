...
void on_menu_projects_open_activate(GSimpleAction* action, GVariant* parameter, gpointer data);
void on_menu_projects_save_activate(GSimpleAction* action, GVariant* parameter, gpointer data);
void on_menu_projects_new_activate(GSimpleAction* action, GVariant* parameter, gpointer data);
void on_menu_projects_close_activate(GSimpleAction* action, GVariant* parameter, gpointer data);
